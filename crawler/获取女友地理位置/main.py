...
class Location(object):
    ...
    def __init__(self, image_path):
        ...
        self.api_key = "2f2b6aff07bc393f34ffbc6102fa7e50"

        self.url_get_position = 'https://restapi.amap.com/v3/geocode/regeo?key={}&location={}'

    def run(self):
        coordinate = self.__get_image_ability()
        # TODO 调试用 设置一个找的到的坐标 正常运行时注释掉
        coordinate = "114.213832, 22.250235"
        print('获取到经度、纬度是:%s' %coordinate)
    ...
    def __get_image_ability(self):
        ...
        if img_exif:
            ...
            if latitude_gps and longitude_gps and take_time:
                ...
                return '%s,%s' %(location[0], location[1])
            else:
                print('获取的图片数据属性不完整')
                return ''
        else:
...
if __name__ == '__main__':
    ...
    # location = Location('./picture/20190915133302.jpg')
